 ...
 */
export function getLoadedCount<T>(collection: Collection<T>): number {
 ...
 */
export async function waitForCollectionSize<T>(
  collection: Collection<T>,
  expectedSize: number,
  timeout = 5000
): Promise<void> {
 ...
 */
export async function waitForCollectionReady<T>(
  collection: Collection<T>,
  timeout = 5000
): Promise<void> {
